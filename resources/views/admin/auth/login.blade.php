	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v4 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url({{asset('assets/admin/media/bg/bg-2.jpg')}});">
                ...
                <form  class="kt-form" method="POST" action="{{ route('admin.login') }}">
                    ...
                    @enderror
									...
									<div class="input-group">
                    <input id="password" type="password" placeholder="{{ __('words.password') }}" class="form-control @error('password') is-invalid @enderror" name="password" required >
                    ...
                    @enderror
									...
									<div class="kt-login__actions">
										<button  type="submit" class="btn btn-brand btn-pill kt-login__btn-primary">{{ __('auth.login') }} </button>
									</div>
									<div class="kt-login__actions">
										<a  href="{{ route('password.email.request') }}" >{{ __('auth.forgot_password_question') }} </a>
										{{-- <br>
										<br>
										&nbsp;&nbsp;{{ $settings['phone_1'] }} &nbsp;&nbsp;-&nbsp;&nbsp;
										{{ $settings['mail'] }} --}}
										</br>
										<h4 ><a style="color: white  !important;" href="https://www.souq.appsjannah.com/register"> اضافه حساب جديد</a></h4>
									</div>
								</form>
							</div>
