            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <h2>تعديل بيانات منتجات  الغاز</h2>
                            <!-- form -->
                            <form class="kt_form_1" enctype="multipart/form-data"
                                action="{{ route('admin.souqProducts.update',['id' => $product->id]) }}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" col-lg-4 col-md-9 col-sm-12">
                                        <input type="text"
                                            ...
                                            maxlength="100"  name="title" placeholder="" value="{{$product->title}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" col-lg-4 col-md-9 col-sm-12">
                                        <input type="text"
                                            ...
                                            maxlength="100" name="describe" placeholder="" value="{{$product->describe}}">
                                        <!-- <span class="form-text text-muted">Please enter your full name</span> -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" col-lg-4 col-md-9 col-sm-12">
                                        <input type="text"
                                            ...
                                            maxlength="100"  name="price" placeholder="" value="{{$product->price}}">
                                        <!-- <span class="form-text text-muted">Please enter your full name</span> -->
                                        @if ($errors->has('price'))
                                ...
                                <input type="number" value="6"  name="category" hidden/>
